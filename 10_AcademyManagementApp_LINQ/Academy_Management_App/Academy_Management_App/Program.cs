...
namespace Academy_Management_App
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Student student1 = new Student(1, "Steph", "Stephenson", "steph123", "stephenson123");
            Student student2 = new Student(2, "Ana", "Anson", "ana123", "anson123");
                                ...
                                if (admins.Where(x => x.UserName == loggedAdminUserName && x.Password == loggedAdminPassword).ToList().Count != 0)
                                {
                                    foreach(Admin admin in admins)
                                    {
                                        if (admin.UserName == loggedAdminUserName && admin.Password == loggedAdminPassword)
                                        {
                                            ...
                                            //adminUserFound = true;
                                            AdminFunctions.selectAdminAction(admins, teachers, students,loggedAdmin);
                                            break;
                                        }
                                    }
                                }
